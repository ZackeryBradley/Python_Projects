#This script will shoe a "DVD" symbol that floats around the screen.
...
try:
    ...
    print('https://pypi.org/project/Bext/') #you must download this module from the website in order for this code to work.
    sys.exit()
